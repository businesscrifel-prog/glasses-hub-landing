      ...
      <header className="sticky top-0 z-40 border-b border-neutral-200 bg-white">
        <div className="mx-auto grid max-w-7xl grid-cols-[auto_1fr_auto] items-center gap-6 px-4 py-3 sm:px-6 lg:px-8">
          <a href="/" className="flex items-center">
            <img src={logoAsset.url} alt="The Glasses Hub" width={1152} height={576} className="h-12 w-auto sm:h-14" />
          </a>
      ...
      <footer className="border-t border-neutral-200 bg-ink text-white">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-8 px-4 py-12 sm:px-6 md:grid-cols-4 lg:px-8">
          <div className="col-span-2 md:col-span-1">
            <img src={logoAsset.url} alt="The Glasses Hub" width={1152} height={576} loading="lazy" className="h-12 w-auto invert" />
